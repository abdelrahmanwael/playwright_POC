...
class perviewTemplateMdPage{
    constructor(page){
        ...
        this.perviewTemplateSection2Btn = page.locator("(//div[@class='col-md-8 col-9'])[2]");
        ...
        this.perviewTemplateSection3Btn = page.locator("(//div[@class='col-md-8 col-9'])[3]");
        this.firstTestSection3 = page.locator("(//input[@id='workingOn60Hz1'])");
        this.secondTestSection3 = page.locator("(//input[@id='matchBarcodeWithRegistration1'])");
        this.thirdTestSection3 = page.locator("(//input[@id='manualGuideIsExist1'])");
        this.perviewTemplateSection4Btn = page.locator("(//div[@class='col-md-8 col-9'])[4]");
...
export default perviewTemplateMdPage